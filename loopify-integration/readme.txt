...
1. Upload the plugin files to `/wp-content/plugins/loopify-integration`
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Go to Loopify settings and enter your API credentials
...
You can choose between hourly, twice daily, or daily sync intervals in the settings.
